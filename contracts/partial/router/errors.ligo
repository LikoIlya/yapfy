...
const cantUnpackBytes          : string = "P_PARSER_BYTES_INVALID";
const noCandidate              : string = "P_NO_CANDIDATE";
const notAdminOrCandidate      : string = "P_NOT_ADMIN_OR_CANDIDATE";
const typeSet                  : string = "P_PARSER_TYPE_SET";
const noParserType             : string = "P_PARSER_TYPE_NOT_SET";
const unknownToken             : string = "P_UNKNOWN_TOKEN";
